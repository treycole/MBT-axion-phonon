...
# mpirun -n $NSLOTS wannier90.x -pp GaN
# cp GaN.wout GaN_pp.wout
# mpirun -n $NSLOTS pw2wannier90.x -pd true -input GaN_pw2wan.in > GaN_pw2wan.out
# mpirun -n $NSLOTS wannier90.x GaN
