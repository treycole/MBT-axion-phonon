...
#mpirun -n 1 projwfc.x -input projwfc_template.in > projwfc_template.out

# Wannier90
mpirun -np $NSLOTS wannier90.x -pp MnBi2Te4_up > MnBi2Te4_up_pp.wout
mpirun -np $NSLOTS wannier90.x -pp MnBi2Te4_down > MnBi2Te4_down_pp.wout
mpirun -np $NSLOTS pw2wannier90.x -pd true -input MnBi2Te4_up_pw2wan.in > MnBi2Te4_up_pw2wan.out
mpirun -np $NSLOTS pw2wannier90.x -pd true -input MnBi2Te4_down_pw2wan.in > MnBi2Te4_down_pw2wan.out
mpirun -np $NSLOTS wannier90.x MnBi2Te4_up > MnBi2Te4_up.wout
mpirun -np $NSLOTS wannier90.x MnBi2Te4_down > MnBi2Te4_down.wout
